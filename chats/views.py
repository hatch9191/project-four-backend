...
from .serializers import BasicChatSerializer, MessageSerializer
...
class ChatListView(APIView):
    ...
    def get(self, request, profile_pk):
        ...
        serialized_chat = BasicChatSerializer(chats, many=True)
...
class ChatCreateView(APIView):
    ...
    def post(self, request, pk):
        ...
        created_chat = BasicChatSerializer(data=request.data)
...
class MessageListView(APIView):
    ...
    def post(self, request, **kwargs):
        ...
        return Response(created_message.errors, status=status.HTTP_4222)
